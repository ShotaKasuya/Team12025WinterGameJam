...
namespace Gambit.Unity.Test.EditMode.Tests.EditModeTest.InGame
{
    public class AddPointTest
    {
        ...
        public void SetUp()
        {
            ...
            _addPointCase = new AddPointCase(_mockPlayerCountModel, _mockScoreModel, _mockResultModel,
                _mockConditionModel);
        }
        ...
        public void AddPointWinTest(int id, Rank winCard, Rank loseCard)
        {
            ...
            var card = new Card[] { new(Suit.Clubs, winCard), new(Suit.Clubs, loseCard) };
            var cards = new PlayerCard[] { new(new PlayerId(0), card[0]), new(new PlayerId(1), card[1]) };
